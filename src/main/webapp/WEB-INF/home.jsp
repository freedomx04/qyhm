...
<%@page import="com.hm.qyhm.entity.authority.UserEntity"%>
...
<!-- 					<li>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="">基本资料</a></li>
							<li><a class="J_menuItem" href="modifyAvatar">修改头像</a></li>
					...
					<li>
						...
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="https://qy.weixin.qq.com/"><i class="fa fa-user fa-fw"></i>微信企业号管理</a></li>						
							<li><a class="J_menuItem" href="https://qy.weixin.qq.com/cgi-bin/home?lang=zh_CN&token=1316347989#index"><i class="fa fa-desktop fa-fw"></i>应用中心</a></li>						
						</ul>
					</li>
				</ul>
			</div>
